...
class ErrorHandler
{
    ...
    private function handleException(\Throwable $e): void
    {
        ...
        $this->logger->log(
            ...
            ['exception' => $e, 'trace' => debug_backtrace(), 'context' => [
                'POST' => $_POST,
                'GET' => $_GET,
                'FILES' => $_FILES,
    ...
    public function handleFatalError(): void
    {
        ...
        if ($lastError && in_array($lastError['type'], self::$fatalErrors, true)) {
            ...
            $this->logger->log(
                ...
                ['code' => $lastError['type'], 'message' => $lastError['message'], 'file' => $lastError['file'], 'line' => $lastError['line'], 'trace' => $trace, 'context' => [
                    'POST' => $_POST,
                    'GET' => $_GET,
                    'FILES' => $_FILES,
                    'URI' => isset($_SERVER['REQUEST_URI']) ? $_SERVER['REQUEST_URI'] : ''
